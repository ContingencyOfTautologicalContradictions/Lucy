...
#define lucy_throwable_self(self, ...) (self, [[maybe_unused]] ::Exception& exception_object_private_and_secret __VA_OPT__(,) __VA_ARGS__)
...
#define lucy_operator_throwable_self(self, type) (self, ::PackedException<type>&& exception_object_private_and_secret)
